...
public class Constants {
    ...
    public static final String JAVA_LIST_ADD_METHOD = "add";
    public static final String JAVA_LIST_ADD_ALL_METHOD = "addAll";
    public static final String JAVA_LIST_SET_METHOD = "set";

    // Set
    public static final String JAVA_SET = "java.util.Set";
    public static final String JAVA_SET_ADD_METHOD = "add";
    public static final String JAVA_SET_ADD_ALL_METHOD = "addAll";
