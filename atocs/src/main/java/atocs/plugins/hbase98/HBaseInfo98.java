...
public class HBaseInfo98 {
    ...
    //HBase API info
    public static final String HBASE98_API_FILE_PATH = "src/main/java/atocs/plugins/hbase98/resources/hbase98.yml";
    public static final String HBASE98_LIB_PATH = "src/main/java/atocs/plugins/hbase98/resources/hbase-client-0.98.6-hadoop2.jar";
